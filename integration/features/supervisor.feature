Feature: Supervisor
    ...
    Scenario: Supervisor can restart llamacpp after being killed
      ...
      Given supervisor-1 is running at 0.0.0.0:8087 with file configuration stored on src/tests/dependencies/supervisor-1.toml and starts llamacpp-1 at 8080 with 4 slots running qwen2_500m.gguf in supervisor feature
      Given supervisor-2 is running at 0.0.0.0:8088 with file configuration stored on src/tests/dependencies/supervisor-2.toml and starts llamacpp-2 at 8081 with 4 slots running qwen2_500m.gguf in supervisor feature
