Feature: Balancer
    ...
    Background:
      ...
      Given llamacpp-1 is running at 127.0.0.1:8080 with 4 slots
      Given llamacpp-2 is running at 127.0.0.1:8081 with 3 slots
      
      When agent-1 is running and observing llamacpp-1 in 127.0.0.1:8080, and registered at balancer-1 in 0.0.0.0:8070
      Then balancer-1 in 0.0.0.0:8070 must report that agent-1 is registered with 4 slots at 127.0.0.1:8080
      
      When agent-2 is running and observing llamacpp-2 in 127.0.0.1:8081, and registered at balancer-1 in 0.0.0.0:8070
      Then balancer-1 in 0.0.0.0:8070 must report that agent-2 is registered with 3 slots at 127.0.0.1:8081
