...
#[given(regex = r"agent-1 is running and observing llamacpp-1, and registered at balancer-1")]
...
#[given(regex = r"agent-2 is running and observing llamacpp-2, and registered at balancer-1")]
...
#[when(regex = r"first request is proxied to balancer")]
...
#[when(regex = r"second request is proxied to balancer")]
...
async fn agent2_cannot_fetch_llamacpp2(world: &mut PaddlerWorld) -> Result<()> {
