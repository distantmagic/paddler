Feature: Balancer
    ...
    #   Given balancer-1 is running at 0.0.0.0:8070, 0.0.0.0:8071 and reports metrics to 0.0.0.0:9125
    #   Given statsd-1 is running at 0.0.0.0 in 9125, 8073 and receives metrics from balancer-1
    #   Given llamacpp-1 is running at 8080 with 4 slots
    #   Given agent-1 is running and observing llamacpp-1 in 127.0.0.1:8080, and registered at balancer-1 in 127.0.0.1:8070
    #   Given llamacpp-2 is running at 8081 with 3 slots
    #   Given agent-2 is running and observing llamacpp-2 in 127.0.0.1:8081, and registered at balancer-1 in 127.0.0.1:8070
    ...
    Scenario: Balancer report metrics
      ...
      Given statsd-1 is running at 0.0.0.0 in 9125 and receives metrics from balancer-1
      Given prometheus-1 is running at 0.0.0.0:9090 and scrapes metrics from 0.0.0.0:9125 every 1 second
      Given llamacpp-1 is running at 8080 with 4 slots
      Given agent-1 is running and observing llamacpp-1 in 127.0.0.1:8080, and registered at balancer-1 in 127.0.0.1:8070
      Given llamacpp-2 is running at 8081 with 3 slots
      Given agent-2 is running and observing llamacpp-2 in 127.0.0.1:8081, and registered at balancer-1 in 127.0.0.1:8070
      ...
      Then statsd-1 must tell 2 slots are busy and 5 slots are idle at 0.0.0.0:9090
