Feature: Balancer
    ...
    Scenario: Balancer can loadbalance
      ...
      Then balancer-1 must tell 1 slot is busy and 6 slots are idle in 127.0.0.1:8070 from agent-1 and agent-2 in balancer feature
      Then balancer-1 must return a successful response in 127.0.0.1:8071 in balancer feature
