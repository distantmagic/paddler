Feature: Agent
    ...
    Scenario: Agent can register
      Given balancer-1 is running at 0.0.0.0:8070 and 0.0.0.0:8071
      ...
      Then balancer-1 must report that agent-1 is registered with 4 slots

      When agent-2 is running and observing llamacpp-2 in 0.0.0.0:8081, and registered at balancer-1 in 0.0.0.0:8070
      Then balancer-1 must report that agent-2 is registered with 3 slots
